...
Welcome to the [Logic RACE](https://logicrace.com) open source code. This software is licensed under the [AGPL-3.0 License](https://github.com/SathvTech/LogicRACE/blob/main/LICENSE.md) which is derived from the license of it's source [Forem](https://github.com/forem/forem) and all the license requirements are inherited.
